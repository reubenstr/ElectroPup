...
class robotKinematics:
    def __init__(self):
        ...
        """in meter """
        self.L = 0.338 #length of robot joints
        self.W = 0.150 #width of robot joints
        self.coxa = 0.036 #coxa length
        self.femur = 0.140 #femur length
        self.tibia = 0.140 #tibia length
    ...
    def solve(self, orn , pos , bodytoFeet):
        ...
        print (FR_angles)
        joint_angles = np.concatenate((FR_angles, FL_angles, BR_angles, BL_angles))
        return joint_angles