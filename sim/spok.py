...
import numpy as np
from legk import LegIK
from liea import RpToTrans, TransToRp, TransInv, RPY, TransformVector
from collections import OrderedDict


class SpotModel:
    def __init__(self,
                 shoulder_length=0.036,
                 elbow_length=0.140,
                 wrist_length=0.140,
                 hip_x=0.338,
                 hip_y=0.175,
    ...
    def IK(self, orn, pos, T_bf):
        ...
        #print(f"[T_bf] \n{T_bf['FL']}")
        #print(f"[hip_to_foot]{'FL'} => {HipToFoot['FL']}")
